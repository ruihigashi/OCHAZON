            ...
            <div class="flex-content">
                ...
                <div class="stock-container">
                    ...
                    <div class="search-box">
                        <input type="text" id="name" name="site-search" class="site-search" placeholder="製品名で検索" />
                        <input type="submit" value="検索" class="search">

                        <input type="text" id="number" name="site-search" class="site-search" placeholder="製品番号で検索" />
                        <input type="submit" value="検索" class="search">
