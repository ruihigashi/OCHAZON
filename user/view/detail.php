  ...
  <div class="detail_root"><!-- 商品の詳細 -->
    ...
    if (isset($_POST['name'])) {
      ...
      if ($result) {
        ...
        echo '              </select>';
        echo '          </div>';
        echo '        <input type="submit" value="カートに入れる" id="detail_cartin"><br>';
        echo '<form action="1login.php">';
        echo '        <input type="submit" value="いますぐ購入" id="detail_buynow"><br>';
        echo '</form>';
        echo '      </div>';
        echo '  </div>';
        echo '      <div class="detail">商品の詳細<br></div>';
        echo '      <div class="detail">商品紹介<br></div>';
        echo '      <div class="detail_introduction">' . htmlspecialchars($result['product_overview']) . '</div>';
        echo '      <div class="detail_introduction">ブランド：' . htmlspecialchars($result['category']) . '</div>';
        echo '      <div class="detail_introduction">内容量：' . htmlspecialchars($result['size']) . '</div>';
        echo '      <div class="detail_introduction">梱包サイズ：100×100(cm)</div>';
        echo '      <div class="detail_introduction">事業者名：' . htmlspecialchars($result['business_name']) . '</div>';
        echo '      <div class="detail_introduction">保存方法：' . htmlspecialchars($result['storage']) . '</div>';
        echo '</div>';
      } else {
